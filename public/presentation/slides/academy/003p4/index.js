...
(lib.academy = function(mode,startPosition,loop) {
	...
	this.hide00popup4.setTransform(948.1,238.95,0.7998,0.83);
	new cjs.ButtonHelper(this.hide00popup4, 0, 1, 2, false, new lib.AreaButton(), 3);

	this.timeline.addTween(cjs.Tween.get(this.hide00popup4).wait(15));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/_01.png?1674230632052", id:"_01"}
	],
	preloads: []
};
