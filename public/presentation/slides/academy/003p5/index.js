...
(lib.academy = function(mode,startPosition,loop) {
	...
	// Buttons
	this.hide00popup5 = new lib.AreaButton();
	this.hide00popup5.name = "hide00popup5";
	this.hide00popup5.setTransform(1154.1,198.95,0.7998,0.83);
	new cjs.ButtonHelper(this.hide00popup5, 0, 1, 2, false, new lib.AreaButton(), 3);

	this.timeline.addTween(cjs.Tween.get(this.hide00popup5).wait(15));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/_01.png?1674230683712", id:"_01"}
	],
	preloads: []
};
