...
lib.ssMetadata = [
		{name:"index_atlas_", frames: [[1563,190,201,201],[1282,190,279,167],[1282,0,575,188],[0,324,1124,243],[1126,393,519,69],[0,0,1280,322]]}
];
...
}).prototype = getMCSymbolPrototype(lib._04, new cjs.Rectangle(77,0,279,167), null);
...
(lib._03 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(156.95,8.05);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib._03, new cjs.Rectangle(157,8.1,575,188), null);
...
(lib._02_1 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(107.95,0);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib._02_1, new cjs.Rectangle(108,0,1124,243), null);
...
}).prototype = getMCSymbolPrototype(lib._01_3, new cjs.Rectangle(419,0,519,69), null);
...
(lib.academy = function(mode,startPosition,loop) {
	...
	this.dispatch00frame_page0.setTransform(481.7,219.05,0.7056,0.91);
	this.dispatch00frame_page0._off = true;
	new cjs.ButtonHelper(this.dispatch00frame_page0, 0, 1, 2, false, new lib.AreaButton(), 3);

	this.timeline.addTween(cjs.Tween.get(this.dispatch00frame_page0).wait(34).to({_off:false},0).wait(10).to({x:666.7,y:217.1},0).wait(10).to({x:927.7},0).wait(10).to({x:1011.7,y:188.15},0).wait(10).to({x:922.95,y:222.1},0).wait(11));
	...
	this.dispatch00frame_page5.setTransform(906.75,503.1,0.5054,1.14);
	...
	this.dispatch00frame_page4.setTransform(722,499.1,0.5054,1.14);
	...
	this.dispatch00frame_page3.setTransform(647.3,503.1,0.5054,1.14);
	...
	this.dispatch00frame_page2.setTransform(378.75,499.1,0.5054,1.14);
	...
	this.dispatch00frame_page1.setTransform(187.75,503.1,0.5054,1.14);
	...
	this.goto00academy7._off = true;
	new cjs.ButtonHelper(this.goto00academy7, 0, 1, 2, false, new lib.AreaButton(), 3);

	this.timeline.addTween(cjs.Tween.get(this.goto00academy7).wait(9).to({_off:false},0).to({_off:true},25).wait(51));
