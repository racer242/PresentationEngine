...
(lib.AreaButton_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer 1
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("rgba(0,255,255,0.902)").s().p("AnzH0IAAvnIPnAAIAAPng");
...
}).prototype = getMCSymbolPrototype(lib._01_3, new cjs.Rectangle(0,0,1280,960), null);
...
}).prototype = getMCSymbolPrototype(lib._01_4, new cjs.Rectangle(0,0,646.2,386.1), null);
...
}).prototype = getMCSymbolPrototype(lib._01_5, new cjs.Rectangle(0,0,1280,960), null);


// stage content:
(lib.rinza = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{page0:24,stop00:27,page1:34,stop01:43,page2:49,stop02:59});
	...
	this.dispatch00frame_page0.setTransform(1080.65,276.9,0.7056,0.91);
	this.dispatch00frame_page0._off = true;
	new cjs.ButtonHelper(this.dispatch00frame_page0, 0, 1, 2, false, new lib.AreaButton(), 3);

	this.timeline.addTween(cjs.Tween.get(this.dispatch00frame_page0).wait(34).to({_off:false},0).wait(15).to({scaleX:0.8157,x:1071.65,y:267.05},0).wait(15));

	// Buttons
	this.goto00rinza5 = new lib.AreaButton_1();
	this.goto00rinza5.name = "goto00rinza5";
	this.goto00rinza5.setTransform(662.45,276.9,3.9595,4.0295);
	new cjs.ButtonHelper(this.goto00rinza5, 0, 1, 2, false, new lib.AreaButton_1(), 3);

	this.goto00rinza4 = new lib.AreaButton_1();
	this.goto00rinza4.name = "goto00rinza4";
	this.goto00rinza4.setTransform(221.45,276.9,3.9595,4.0295);
	new cjs.ButtonHelper(this.goto00rinza4, 0, 1, 2, false, new lib.AreaButton_1(), 3);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.goto00rinza4},{t:this.goto00rinza5}]},56).wait(8));

	// Layer_11
	this.instance = new lib._01_3();
	this.instance.setTransform(640,480,1,1,0,0,0,640,480);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(49).to({_off:false},0).to({alpha:1},9,cjs.Ease.get(1)).wait(6));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.goto00rinza7},{t:this.goto00rinza8}]},42).to({state:[]},7).wait(15));

	// Layer_9
	this.instance_1 = new lib._01_5();
	this.instance_1.setTransform(640,480,1,1,0,0,0,640,480);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(34).to({_off:false},0).to({alpha:1},9,cjs.Ease.get(1)).to({_off:true},6).wait(15));

	// Buttons
	this.dispatch00frame_page2 = new lib.AreaButton();
	this.dispatch00frame_page2.name = "dispatch00frame_page2";
	this.dispatch00frame_page2.setTransform(974,706.3,2.4679,0.7801,0,0,0,0.1,0.1);
	...
	this.dispatch00frame_page1.setTransform(746.55,708.35,2.2763,0.7596,0,0,0,0.2,0.1);
	new cjs.ButtonHelper(this.dispatch00frame_page1, 0, 1, 2, false, new lib.AreaButton(), 3);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.dispatch00frame_page1},{t:this.dispatch00frame_page2}]},9).to({state:[]},25).wait(30));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.goto00rinza3},{t:this.goto00rinza9},{t:this.show00popup1},{t:this.goto00rinza2}]}).to({state:[]},34).wait(30));

	// Layer_2
	this.instance_2 = new lib._04();
	this.instance_2.setTransform(1045.1,611.15,1,1,0,0,0,284.9,97);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(10).to({_off:false},0).to({x:995.1,alpha:1},9,cjs.Ease.get(1)).wait(45));

	// Layer_6
	this.instance_3 = new lib._02_1();
	this.instance_3.setTransform(826.2,279.1,1,1,0,0,0,156,279.1);
	this.instance_3.alpha = 0;
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(4).to({_off:false},0).to({x:776.2,alpha:1},9,cjs.Ease.get(1)).wait(51));

	// Layer_5
	this.instance_4 = new lib._03_1();
	this.instance_4.setTransform(1127.05,474.1,1,1,0,0,0,202.8,106);
	this.instance_4.alpha = 0;
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(7).to({_off:false},0).to({x:1077.05,alpha:1},9,cjs.Ease.get(1)).wait(48));

	// Layer_7
	this.instance_5 = new lib._01_4();
	this.instance_5.setTransform(323.1,483.2,1,1,0,0,0,323.1,193.1);
	this.instance_5.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({y:513.2,alpha:1},9,cjs.Ease.get(1)).wait(55));

	// Layer_4
	this.instance_6 = new lib._05();
	this.instance_6.setTransform(811,801.2,1,1,0,0,0,468.9,65);
	this.instance_6.alpha = 0;
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(4).to({_off:false},0).to({y:771.2,alpha:1},9,cjs.Ease.get(1)).wait(51));

	// Layer_1
	this.instance_7 = new lib._01();
	this.instance_7.setTransform(0,0,0.5926,0.5926);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/_01.jpg?1675092419323", id:"_01"},
		{src:"images/_01_1.png?1675092419323", id:"_01_1"},
		{src:"images/_01_2.png?1675092419323", id:"_01_2"},
		{src:"images/_02.png?1675092419323", id:"_02"},
		{src:"images/_03.png?1675092419323", id:"_03"}
	],
	preloads: []
};
