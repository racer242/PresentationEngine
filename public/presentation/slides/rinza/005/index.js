...
(lib.rinza = function(mode,startPosition,loop) {
	...
	// Buttons
	this.goto00rinza6 = new lib.AreaButton();
	this.goto00rinza6.name = "goto00rinza6";
	this.goto00rinza6.setTransform(97.35,794.2,0.7482,0.86,0,0,0,0.2,0);
	new cjs.ButtonHelper(this.goto00rinza6, 0, 1, 2, false, new lib.AreaButton(), 3);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.show00popup2},{t:this.show00popup1},{t:this.goto00rinza6}]},7).wait(13));

	// Layer_3
	this.instance = new lib._02_1();
	this.instance.setTransform(967.05,568.2,1,1,0,0,0,362.9,214.1);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(4).to({_off:false},0).to({x:917.05,alpha:1},9,cjs.Ease.get(1)).wait(7));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/_01.jpg?1674221096769", id:"_01"},
		{src:"images/_02.png?1674221096769", id:"_02"},
		{src:"images/_03.png?1674221096769", id:"_03"}
	],
	preloads: []
};
