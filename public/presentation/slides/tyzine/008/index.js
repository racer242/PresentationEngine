...
(lib._01_1 = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.bf(img._02, null, new cjs.Matrix2D(0.593,0,0,0.593,-672,-485.1)).s().p("Ehe/AkuMAAAhJcMC9/AAAMAAABJcg");
...
(lib.tyzine = function(mode,startPosition,loop) {
	...
	this.goto00tyzine7.setTransform(1152.55,616.25,0.5682,0.5401,0,0,0,0.2,0);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.show00popup1},{t:this.goto00tyzine7}]}).wait(15));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/_01.jpg?1674225466935", id:"_01"},
		{src:"images/_02.png?1674225466935", id:"_02"}
	],
	preloads: []
};
