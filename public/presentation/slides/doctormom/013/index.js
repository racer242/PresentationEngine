...
(lib._01_1 = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.bf(img._02, null, new cjs.Matrix2D(0.593,0,0,0.593,-609.1,-471.2)).s().p("EhfKgrSMC+VAAAMAAABWkMi+VAABg");
...
(lib.doctormom = function(mode,startPosition,loop) {
	...
	this.goto00doctormom15.setTransform(99.75,798.3,0.6851,0.7296);
	new cjs.ButtonHelper(this.goto00doctormom15, 0, 1, 2, false, new lib.AreaButton(), 3);

	this.goto00doctormom14 = new lib.AreaButton();
	this.goto00doctormom14.name = "goto00doctormom14";
	this.goto00doctormom14.setTransform(1158.65,673.3,0.445,0.4796);
	new cjs.ButtonHelper(this.goto00doctormom14, 0, 1, 2, false, new lib.AreaButton(), 3);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.show00popup1},{t:this.goto00doctormom14},{t:this.goto00doctormom15}]},9).wait(11));

	// Layer_2
	this.instance = new lib._01_1();
	this.instance.setTransform(325.1,461.2,1,1,0,0,0,325.1,237.1);
	this.instance.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance).to({y:511.2,alpha:1},9,cjs.Ease.get(1)).wait(11));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/_01.jpg?1674234077278", id:"_01"},
		{src:"images/_02.png?1674234077278", id:"_02"}
	],
	preloads: []
};
