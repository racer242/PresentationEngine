...
(lib.doctormom = function(mode,startPosition,loop) {
	...
	this.goto00doctormom9.setTransform(1158.65,623.3,0.445,0.4796);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.show00popup1},{t:this.goto00doctormom9}]},9).wait(11));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/_01.jpg?1674233693445", id:"_01"},
		{src:"images/_02.png?1674233693445", id:"_02"}
	],
	preloads: []
};
