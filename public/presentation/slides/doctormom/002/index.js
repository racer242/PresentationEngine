...
(lib._01_1 = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.bf(img._02, null, new cjs.Matrix2D(0.593,0,0,0.593,-679,-522.1)).s().p("Ehd5AitMAAAhFZMC7zAAAMAAABFZg");
	this.shape.setTransform(600.975,222.075);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib._01_1, new cjs.Rectangle(0,0,1202,444.2), null);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/_01.jpg?1674227650529", id:"_01"},
		{src:"images/_02.png?1674227650529", id:"_02"}
	],
	preloads: []
};
