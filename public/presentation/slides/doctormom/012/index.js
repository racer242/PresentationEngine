...
(lib.doctormom = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.show00popup1},{t:this.goto00doctormom11}]}).wait(20));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/_01.jpg?1674233790482", id:"_01"},
		{src:"images/_02.png?1674233790482", id:"_02"}
	],
	preloads: []
};
