...
(lib.doctormom = function(mode,startPosition,loop) {
	...
	this.goto00doctormom7.setTransform(26.1,796.2,0.7149,0.7395);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.show00popup1},{t:this.goto00doctormom7}]},7).wait(13));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/_01.jpg?1674233444494", id:"_01"},
		{src:"images/_02.png?1674233444494", id:"_02"}
	],
	preloads: []
};
