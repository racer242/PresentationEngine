...
(lib._02_1 = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.bf(img._02, null, new cjs.Matrix2D(0.593,0,0,0.593,-986.1,-554.1)).s().p("Egt6AoBMAAAhQAMBb1AAAMAAABQAg");
	this.shape.setTransform(233.9,216.05);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib._02_1, new cjs.Rectangle(-60,-40,587.8,512.1), null);
...
(lib._01_1 = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.bf(img._02, null, new cjs.Matrix2D(0.593,0,0,0.593,-319.1,-511.2)).s().p("Egx2glCMBjtAAAMAAABKEMhjtAABg");
	this.shape.setTransform(319.075,237.075);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib._01_1, new cjs.Rectangle(0,0,638.2,474.2), null);
...
(lib.doctormom = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.show00popup2},{t:this.goto00doctormom8}]},7).wait(13));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/_01.jpg?1674229075641", id:"_01"},
		{src:"images/_02.png?1674229075641", id:"_02"}
	],
	preloads: []
};
