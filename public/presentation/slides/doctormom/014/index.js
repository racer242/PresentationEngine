...
(lib.doctormom = function(mode,startPosition,loop) {
	...
	this.goto00doctormom15.setTransform(97.75,798.25,0.7251,0.7095);
	...
	this.goto00doctormom11.setTransform(1158.65,623.3,0.445,0.4796);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.show00popup1},{t:this.goto00doctormom11},{t:this.goto00doctormom15}]}).wait(20));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/_01.jpg?1674234225630", id:"_01"},
		{src:"images/_02.png?1674234225630", id:"_02"}
	],
	preloads: []
};
