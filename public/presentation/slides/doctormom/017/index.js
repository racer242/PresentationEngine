...
(lib._01_1 = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.bf(img._02, null, new cjs.Matrix2D(0.593,0,0,0.593,-609.1,-491.2)).s().p("EhfKguaMC+VAAAMAAABc0Mi+VAABg");
	this.shape.setTransform(609.075,217.075);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib._01_1, new cjs.Rectangle(0,-80,1218.2,594.2), null);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/_01.jpg?1674234819995", id:"_01"},
		{src:"images/_02.png?1674234819995", id:"_02"}
	],
	preloads: []
};
