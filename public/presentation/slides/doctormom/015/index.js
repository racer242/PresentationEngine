...
(lib.doctormom = function(mode,startPosition,loop) {
	...
	this.goto00doctormom13.setTransform(26.75,798.3,0.6851,0.7296);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.show00popup1},{t:this.goto00doctormom13}]},9).wait(11));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/_01.jpg?1674321344725", id:"_01"},
		{src:"images/_02.png?1674321344725", id:"_02"}
	],
	preloads: []
};
