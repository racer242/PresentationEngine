...
(lib._02_1 = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.bf(img._02, null, new cjs.Matrix2D(0.8,0,0,0.8,-640,-542.1)).s().p("Ehj/AkkMAAAhIfMCVtgABIAAgoMAySAAAMAAABJIg");
	this.shape.setTransform(640,234.05);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib._02_1, new cjs.Rectangle(0,0,1280,468.1), null);
...
(lib._01_1 = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.bf(img._02, null, new cjs.Matrix2D(0.8,0,0,0.8,-1136.1,-208.1)).s().p("A2eH0IAAvnMAs9AAAIAAPng");
	this.shape.setTransform(143.875,50.025);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib._01_1, new cjs.Rectangle(0,0,287.8,100.1), null);
...
(lib.hexoral = function(mode,startPosition,loop) {
	...
	// Layer_3
	this.shape = new cjs.Shape();
	this.shape.graphics.bf(img._02, null, new cjs.Matrix2D(0.8,0,0,0.8,-640,-553)).s().p("EBSjA/mIAA8GIRdAAIAAcGgEhj/g/lMCVtAAAIAAZ9MiVtAAAg");
	this.shape.setTransform(640,553.025);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(25));

	// Layer_5
	this.instance = new lib._01_1();
	this.instance.setTransform(1136.05,208.05,1,1,0,0,0,143.8,50);
	...
	this.instance_1.setTransform(640,512.2,1,1,0,0,0,640,234.1);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(4).to({_off:false},0).to({y:542.2,alpha:1},9,cjs.Ease.get(1)).wait(12));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/_01.jpg?1676037281731", id:"_01"},
		{src:"images/_02.png?1676037281731", id:"_02"}
	],
	preloads: []
};
