...
(lib.hexoral = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(34).to({_off:false},0).wait(15));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/_01.jpg?1676038851217", id:"_01"},
		{src:"images/_02.png?1676038851217", id:"_02"},
		{src:"images/_02_1.png?1676038851217", id:"_02_1"},
		{src:"images/_02_2.png?1676038851217", id:"_02_2"}
	],
	preloads: []
};
