...
(lib._02_1 = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.bf(img._02, null, new cjs.Matrix2D(0.593,0,0,0.593,-377.1,-554.1)).s().p("Eg66AWgMAAAgs/MB11AAAMAAAAs/g");
	this.shape.setTransform(377.1,144.025);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib._02_1, new cjs.Rectangle(0,0,754.2,288.1), null);
...
(lib.virus = function(mode,startPosition,loop) {
	...
	this.goto00virus2.setTransform(25.6,801.25,0.7,0.7);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(4).to({_off:false},0).to({y:554.05,alpha:1},10,cjs.Ease.get(1)).wait(11));

	// Layer_3
	this.instance_1 = new lib._01_1();
	this.instance_1.setTransform(670,480,1,1,0,0,0,640,480);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({x:640},19,cjs.Ease.get(1)).wait(6));
