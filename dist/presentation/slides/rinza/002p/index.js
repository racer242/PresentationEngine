...
}).prototype = getMCSymbolPrototype(lib._1, new cjs.Rectangle(0,0,1280,960), null);
...
(lib.rinza = function(mode,startPosition,loop) {
	...
	this.hide00popup1.parent = this;
	this.hide00popup1.setTransform(1127.95,524.9);
	new cjs.ButtonHelper(this.hide00popup1, 0, 1, 2, false, new lib.AreaButton(), 3);

	this.timeline.addTween(cjs.Tween.get(this.hide00popup1).wait(15));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/_4.png?1642052857658", id:"_4"}
	],
	preloads: []
};
